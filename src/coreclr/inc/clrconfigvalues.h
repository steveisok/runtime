...
RETAIL_CONFIG_DWORD_INFO_EX(INTERNAL_CrashReportMiniDump, W("CrashReportMiniDump"), 0, "Enable lifecycle-managed in-proc crash report minidump generation", CLRConfig::LookupOptions::ParseIntegerAsBase10)
