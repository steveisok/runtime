...
namespace System.Diagnostics.Tracing
{
    ...
    public partial class EventSource : System.IDisposable
    {
        ...
        [System.CLSCompliantAttribute(false)]
        protected nint DefineEvent(int eventId, string eventName, System.Diagnostics.Tracing.EventLevel level, System.Diagnostics.Tracing.EventKeywords keywords, System.Diagnostics.Tracing.EventOpcode opcode = System.Diagnostics.Tracing.EventOpcode.Info, System.Diagnostics.Tracing.EventTask task = System.Diagnostics.Tracing.EventTask.None, System.Diagnostics.Tracing.EventTags tags = System.Diagnostics.Tracing.EventTags.None, string? message = null) { throw null; }
        [System.CLSCompliantAttribute(false)]
        protected unsafe void WriteEventDirect(int eventId, nint eventHandle, System.Guid* activityId, System.Guid* relatedActivityId, int eventDataCount, System.Diagnostics.Tracing.EventSource.EventData* data) { }
        [System.CLSCompliantAttribute(false)]
        protected unsafe void WriteSelfDescribingEvent(string eventName, System.Diagnostics.Tracing.EventLevel level, System.Diagnostics.Tracing.EventKeywords keywords, System.Diagnostics.Tracing.EventOpcode opcode, System.Diagnostics.Tracing.EventTags tags, byte* nameMetadata, int nameMetadataLength, byte* typeMetadata, int typeMetadataLength, System.Guid* activityId, System.Guid* relatedActivityId, int eventDataCount, System.Diagnostics.Tracing.EventSource.EventData* data) { }
        [System.Diagnostics.CodeAnalysis.RequiresUnreferencedCode("EventSource will serialize the whole object graph. Trimmer will not safely handle this case because properties may be trimmed. This can be suppressed if the object is a primitive type")]
