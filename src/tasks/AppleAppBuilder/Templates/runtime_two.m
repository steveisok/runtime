...
void
runtime_two_init (const char *bundle)
{
    rlog = os_log_create ("RUNTIME_TWO", "default");
    mono_trace_set_log_name ("RUNTIME_TWO");
    ...
    MonoDomain *domain = mono_jit_init_version ("dotnet.ios", "runtime-two");
    assert (domain);
...
int
runtime_two_exec (const char *executable, int argi, const char *managed_argv)
{
    int res;
