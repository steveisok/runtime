...
public class MonoAOTCompiler : Microsoft.Build.Utilities.Task
{
    ...
    /// <summary>
    /// Enables symbols export of methods marked by UnmanagedCallersOnlyAttribute
    /// </summary>
    public bool ExportUnmanagedCallersOnlyMethods { get; set; }
    ...
    private PrecompileArguments GetPrecompileArgumentsFor(ITaskItem assemblyItem, string? monoPaths)
    {
        ...
        if (ExportUnmanagedCallersOnlyMethods)
        {
